...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Whiteapp_ShopFinder::shopfinder')
            ->addBreadcrumb(__('Whiteapp ShopFinder'), __('Whiteapp ShopFinder'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('shopfinder', $model);

        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->addBreadcrumb(__('Whiteapp'), __('Whiteapp'));
